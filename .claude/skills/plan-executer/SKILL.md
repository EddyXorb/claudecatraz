...
3. If this subagent has no further steps queued, let its worktree tear down. If it's continuing to the next wave (see the chaining note in 2a), leave it alive and re-sync it once `base_branch` has moved.

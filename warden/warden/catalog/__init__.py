...
Public surface other modules should import from — ``policy.py``,
``api_proxy.py``, ``__main__.py`` and ``app.py`` all import ``warden.catalog``
rather than reaching into a submodule directly:

...
SUPPORTED is every project.*/instance.* action plus the two transport-shared
actions this guard also recognizes over REST. Accessed qualified, never imported bare."""

...
class Out:
    ...
    def head(self, s: str) -> None: print(self.bold(s))
    def info(self, s: str) -> None: print(s)
    def warn(self, s: str) -> None: print(self.yellow(f"warning: {s}"), file=sys.stderr)
    def err(self, s: str) -> None: print(self.red(f"error: {s}"), file=sys.stderr)
